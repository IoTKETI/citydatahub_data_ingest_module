...
public class WeatherForecast extends AbstractConvertSink<RequestMessageVO, JSONObject> {
  ...
  public Map<String, Object> doit() throws CoreException {
    try {
      ...
      // 배열 처리
      JsonUtil.objectToParam(param, (JSONArray)jsonEx.getObj("weatherPrediction.value"));

      param.put("weatherObservedAt", jsonEx.getDate("weatherPrediction.observedAt"));
