...
public class TagData extends AbstractConvertSink<RequestMessageVO, JSONObject> {
  ...
  public Map<String, Object> doit() throws CoreException {
    ...
    try {
      ...
      JsonUtil.objectToParam(param, (JSONObject)jsonEx.getObj("tagData.value") );

      param.put("tagName", jsonEx.getObj("tagName"));
      param.put("value", jsonEx.getObj("value"));
      param.put("quality", jsonEx.getObj("quality"));
      param.put("timestamp", jsonEx.getObj("timestamp"));
