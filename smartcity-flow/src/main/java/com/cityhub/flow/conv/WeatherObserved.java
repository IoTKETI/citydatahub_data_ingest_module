...
public class WeatherObserved extends AbstractConvertSink<RequestMessageVO, JSONObject> {
  ...
  public Map<String, Object> doit() throws CoreException {
    ...
    try {
      ...
      JsonUtil.objectToParam(param, (JSONObject)jsonEx.getObj("weatherObservation.value") );

      param.put("locationObservedAt", jsonEx.getDate("location.observedAt"));
      param.put("weatherObservedAt", jsonEx.getDate("weatherObservation.observedAt"));
