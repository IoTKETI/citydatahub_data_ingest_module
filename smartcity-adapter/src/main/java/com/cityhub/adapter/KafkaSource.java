...
import static com.cityhub.environment.KafkaSourceConstants.DEFAULT_GROUP_ID;
import static com.cityhub.environment.KafkaSourceConstants.DEFAULT_MIGRATE_ZOOKEEPER_OFFSETS;
import static com.cityhub.environment.KafkaSourceConstants.KAFKA_CONSUMER_PREFIX;
import static com.cityhub.environment.KafkaSourceConstants.MIGRATE_ZOOKEEPER_OFFSETS;
import static com.cityhub.environment.KafkaSourceConstants.OFFSET_HEADER;
import static com.cityhub.environment.KafkaSourceConstants.ZOOKEEPER_CONNECT_FLUME_KEY;
...
import com.cityhub.environment.KafkaSourceConstants;
  ...
  protected Status doProcess() throws EventDeliveryException {
    ...
    try {
      ...
      while (eventList.size() < batchUpperLimit &&
        ...
        // 카프카에서 받은 다음. 채널로 전송 eventBody
        log.info("send : {}" ,new String(eventBody));
