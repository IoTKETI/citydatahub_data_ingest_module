				...
				for (int j = 0; j < urlC.length(); j++) {
					...
					if (ju.has("response.body.items.item")) {
						...
						if (item != null) {	
							...
							Object[][] A07_1 = { { 0, "low" }, { 3, "normal" }, { 6, "high" }, { 8, "very high" },
									{ 11, "danger" } };
							Object[][] A41 = { { 0, "nomal" }, { 29, "attetion" }, { 31, "caution" }, { 34, "warning" },
									{ 37, "danger" } };
							Object[][] A44 = { { 0, "nomal" }, { 31, "attetion" }, { 33, "caution" }, { 35, "warning" },
									{ 38, "danger" } };
