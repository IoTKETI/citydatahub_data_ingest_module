...
//    // Chart Balance Bar2
//    // ============================================================== 
//    var ctx = document.getElementById("chartjs_balance_bar2").getContext('2d');
//    var myChart = new Chart(ctx, {
//        type: 'bar',
//
//        
//        data: {
//            labels: ["Open API", "OneM2M", "Legacy Platform", "도시통합 Platform"],
//            datasets: [{
//                label: '성공',
//                data: [800, 200, 30, 6],
...
//
    ...
    var chart = c3.generate({
        bindto: "#account",
        color: { pattern: ["#5969ff", "#ff407b", "#25d5f2", "#ffc750", "#03c75a"] },
        data: {
            // iris data from R
            columns: [
                ['9001:데이터 변환 실패', 120],
