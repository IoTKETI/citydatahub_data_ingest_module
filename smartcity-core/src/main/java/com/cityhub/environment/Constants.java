...
public class Constants {
  ...
  /** Entity Context key */
  public static final String ENTITY_CONTEXT_KEY = "@context";
  /** Context type package path */
  public static final String CONTEXT_TYPE_PATH = "com.cityhub.data.service.conv.";
