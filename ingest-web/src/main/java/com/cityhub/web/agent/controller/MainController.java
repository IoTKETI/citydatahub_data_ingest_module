...
public class MainController {
  ...
  public ResponseEntity<String> HealthMeasurement(@PathVariable("path") String path, @RequestBody Map param, HttpServletResponse response) {
    ...
    try {
      if (path.equals("VivaInnovation")) {
        ...
        List<Map<String, Object>> entities = objectMapper.readValue(rtnStr, new TypeReference<List<Map<String, Object>>>() {
        });
