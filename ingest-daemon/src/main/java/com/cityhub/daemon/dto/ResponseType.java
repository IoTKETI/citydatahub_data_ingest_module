 ...
 */
package com.cityhub.daemon.dto;
...
public enum ResponseType {
	...
	NOT_FOUND("4004", "Not Found", "http://eiss.cdc.go.kr/errors/NotFound", HttpStatus.NOT_FOUND),
	...
	INTERNAL_ERROR("5000", "Internal Error", "http://eiss.cdc.go.kr/errors/InternalError", HttpStatus.INTERNAL_SERVER_ERROR),
	INTERNAL_SERVER_ERROR("5000", "Internal Server Error", "http://eiss.cdc.go.kr/errors/InternalServerError", HttpStatus.INTERNAL_SERVER_ERROR),
  ...
  SUBSCRIPTION_NOT_MATCHED("4011", "Subscription Not Matched", "http://eiss.cdc.go.kr/errors/SubscriptionNotMatched", HttpStatus.OK),
	...
	private ResponseType(String code, String title, String detail, HttpStatus httpStatusCode) {
		this.code = code;
		this.title = title;
		this.detail = detail;
