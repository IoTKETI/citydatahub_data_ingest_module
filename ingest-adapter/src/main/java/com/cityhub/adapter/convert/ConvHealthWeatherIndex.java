...
public class ConvHealthWeatherIndex extends AbstractConvert {
  ...
  public String doit() throws CoreException {
    ...
    String[][] types = { { "asthmaIndex", "getAsthmaIdx" }, { "strokeIndex", "getStrokeIdx" }, { "foodpoisonIndex", "getFoodPoisoningIdx" }, { "oakpollenriskIndex", "getOakPollenRiskIdx" },
        { "pinepollenriskIndex", "getPinePollenRiskIdx" }, { "weedspollenriskIndex", "getWeedsPollenRiskndx" }, { "coldIndex", "getColdIdx" }, { "skindiseaseIndex", "getSkinDiseaseIdx" } };
    ...
    try {
      ...
      for (int i = 0; i < svcList.length(); i++) {
        ...
        jsonUtil.put("@context", new JSONArray().put("http://uri.etsi.org/ngsi-ld/core-context.jsonld").put("http://cityhub.kr/ngsi-ld/weather.jsonld"));
