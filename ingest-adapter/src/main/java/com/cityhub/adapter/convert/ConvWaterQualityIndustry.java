...
public class ConvWaterQualityIndustry extends AbstractConvert {
  ...
  public String doit() throws CoreException {
    ...
    JSONObject ItemAdapter = new JsonUtil().getFileJsonObject("openapi/WaterQualityIndustryItemAdapter.conf");
