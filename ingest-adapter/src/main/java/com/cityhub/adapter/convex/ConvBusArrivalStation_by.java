      ...
      for (int i = 0; i < svcList.length(); i++) {
        ...
        if (ju.has("response.msgBody.busArrivalList")) {
          ...
          for (Object obj : arrList) {
        	  ...
        	  wMap.put("startNodeId", item.optString("startNodeId", "0"));
	          ...
	          Map<String,Object> busArrivalIinfo = new LinkedHashMap<>();
	          busArrivalIinfo.put("type", "Property");
	          busArrivalIinfo.put("observedAt", DateUtil.getTime());
	          busArrivalIinfo.put("value", wMap);
