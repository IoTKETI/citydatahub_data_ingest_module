...
public enum ResponseType {
  ...
  OK("2000", "OK", "http://eiss.cdc.go.kr/success/OK", HttpStatus.OK), ACCEPTED("2002", "Accepted", "http://eiss.cdc.go.kr/success/Accepted", HttpStatus.ACCEPTED),
  ...
  RESOURCE_NOT_FOUND("4004", "Resource Not Found", "http://eiss.cdc.go.kr/errors/ResourceNotFound", HttpStatus.NOT_FOUND), CREATED("2001", "Created", "", HttpStatus.CREATED),
  ...
  NOT_FOUND("4004", "Not Found", "http://eiss.cdc.go.kr/errors/ResourceNotFound", HttpStatus.NOT_FOUND), METHOD_NOT_ALLOWED("4005", "Method Not Allowed", " ", HttpStatus.METHOD_NOT_ALLOWED),
  ...
  // INVAILD_PARAMETER_TYPE("4102", "Invaild Parameter Type",
  // HttpStatus.BAD_REQUEST),
