...
@Slf4j
public class ConvWeatherMeasurement_Static_SiheungLivingLab extends AbstractNormalSource {
            ...
            if (gMVL.has("list")) {
              ...
              for (Object MVLobj : MVLList) {
                ...
                if (MVLitem.has("windDirection"))
                  Find_wMap(tMap, "windDirection").put("value", MVLitem.optDouble("windDirection", 0.0d));
                else
                ...
                if (MVLitem.has("seaLevelPressure"))
                  Find_wMap(tMap, "seaLevelPressure").put("value", MVLitem.optDouble("seaLevelPressure", 0.0d));
                else
                ...
                if (MVLitem.has("hourlyRainfall"))
                  Find_wMap(tMap, "hourlyRainfall").put("value", MVLitem.optDouble("hourlyRainfall", 0.0d));
                else
                  Delete_wMap(tMap, "hourlyRainfall");

                if (MVLitem.has("dailyRainfall"))
                  Find_wMap(tMap, "dailyRainfall").put("value", MVLitem.optDouble("dailyRainfall", 0.0d));
                else
                  Delete_wMap(tMap, "dailyRainfall");

                if (MVLitem.has("vaporPressure"))
                  Find_wMap(tMap, "vaporPressure").put("value", MVLitem.optDouble("vaporPressure", 0.0d));
                else
                ...
                if (MVLitem.has("snowfallHour3"))
                  Find_wMap(tMap, "snowfallHour3").put("value", MVLitem.optDouble("snowfallHour3", 0.0d));
                else
