...
public class VData extends AbstractConvertSink<RequestMessageVO, JSONObject> {
  ...
  public Map<String, Object> doit() throws CoreException {
    ...
    try {
      ...
      JsonUtil.objectToParam(param, (JSONObject)jsonEx.getObj("VData.value") );

      param.put("port", jsonEx.getObj("port"));
      param.put("observedAt", jsonEx.getObj("observedAt"));
      param.put("rawData", jsonEx.getObj("rawData"));
